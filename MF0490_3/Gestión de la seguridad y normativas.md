...
1. **Norma ISO/IEC 27002: Código de buenas prácticas para la gestión de la seguridad de la información**

   La ISO/IEC 27002 es una norma internacional que proporciona un marco de referencia para la gestión de la seguridad de la información. Se centra en la implementación de controles para mitigar riesgos relacionados con la confidencialidad, integridad y disponibilidad de la información. Entre sus principales puntos, incluye:
   - **Políticas de seguridad**: directrices y procedimientos.
   - **Gestión de activos**: identificación y protección de los activos informáticos.
   - **Control de accesos**: regulación de quién puede acceder a qué recursos.
   - **Cifrado**: salvaguardar la información mediante técnicas criptográficas.

   **Enlace a la norma**: Aunque la ISO/IEC 27002 es una norma de pago, puedes encontrar más detalles y una visión general en los siguientes recursos:
   - [Resumen de la ISO 27002](https://www.youtube.com/watch?v=E2ZsCRnaYQ8)
   - [ISO/IEC 27002:2022 Controles Organizacionales](https://www.isotools.us/2022/07/29/iso-iec-270022022-controles-organizacionales-todo-lo-que-necesitas-saber/)

2. **Metodología ITIL: Librería de infraestructuras de las tecnologías de la información**

   ITIL (Information Technology Infrastructure Library) es un conjunto de prácticas recomendadas para la gestión de servicios de TI. Su objetivo es mejorar la eficiencia de las empresas al gestionar los servicios tecnológicos. ITIL se organiza en cinco fases del ciclo de vida del servicio:
   - **Estrategia del servicio**: definición de los servicios en función de las necesidades empresariales.
   - **Diseño del servicio**: creación de los servicios y soluciones adecuadas.
   - **Transición del servicio**: implementación y despliegue de los servicios.
   - **Operación del servicio**: gestión de los servicios una vez operativos.
   - **Mejora continua del servicio**: ajustes y optimizaciones constantes.

   **Enlace a la metodología**: Puedes consultar más sobre ITIL en:
   - [Guía ITIL - AXELOS](https://www.axelos.com/best-practice-solutions/itil)

3. **Ley Orgánica de Protección de Datos de Carácter Personal (LOPD)**
   
   La LOPD, actualmente reemplazada por el Reglamento General de Protección de Datos (RGPD) a nivel europeo y la Ley Orgánica 3/2018 de Protección de Datos Personales y garantía de los derechos digitales (LOPDGDD) en España, tiene como objetivo garantizar y proteger el tratamiento de datos personales y los derechos fundamentales de las personas en este contexto.
   - **Derechos de los interesados**: derechos de acceso, rectificación, cancelación y oposición (ARCO), además de los derechos de portabilidad y olvido con la entrada del RGPD.
   - **Principios del tratamiento**: consentimiento, confidencialidad, seguridad, minimización de datos.
   - **Responsabilidades**: medidas que deben tomar las empresas para cumplir con la normativa, como realizar evaluaciones de impacto y notificar violaciones de seguridad.

   **Enlace a la ley**: Más información disponible en:
   ...
   - [Página oficial del RGPD (UE)](https://ec.europa.eu/info/law/law-topic/data-protection_es)

4. **Normativas más frecuentemente utilizadas para la gestión de la seguridad física**

   La seguridad física en el ámbito de la informática abarca la protección de las instalaciones, equipos y personas ante amenazas físicas, como incendios, robos o desastres naturales. Existen varias normativas que regulan y recomiendan buenas prácticas para gestionar la seguridad física, como:
   - **Norma ISO/IEC 27001**: Proporciona controles de seguridad física dentro de su estructura.
   - **Norma TIA-942**: Se utiliza para el diseño y gestión de centros de datos, garantizando aspectos relacionados con la seguridad física, tales como el control de acceso y la protección contra incendios.
   - **Norma NFPA 75**: Relacionada con la protección contra incendios en centros de procesamiento de datos.
   - **Ley de Prevención de Riesgos Laborales**: En algunos casos, las medidas de seguridad física también pueden estar reguladas por leyes nacionales de salud y seguridad en el trabajo.

   **Enlace a las normativas**:
   
   - [Implementación de ISO/IEC 27001 (Centro Criptológico Nacional - España)](https://www.ccn-cert.cni.es/es/seguridad-al-dia/novedades-ccn-cert/12666-actualizada-la-guia-ccn-stic-825-sobre-el-esquema-nacional-de-seguridad-y-la-certificacion-27001.html)
   - [TIA-942: Diseño de centros de datos](https://global.ihs.com/doc_detail.cfm?document_name=TIA%2D942&item_s_key=00516617)
   - [NFPA 75: Protección de equipos de TI](https://www.nfpa.org/codes-and-standards/all-codes-and-standards/list-of-codes-and-standards/detail?code=75)
   
   **Enlaces a información genérica:**
   
   - [Protecciones físicas que pueden evitar riesgos de ciberseguridad](https://www.incibe.es/ciudadania/blog/protecciones-fisicas-evitar-riesgos-ciberseguridad)
...
1. **Identificación de procesos de negocio soportados por sistemas de información**
   ...
   Los **procesos de negocio** se refieren a las actividades que una organización realiza para alcanzar sus objetivos. Estos procesos son soportados por sistemas de información que permiten la automatización, seguimiento y mejora de la eficiencia. Los sistemas de información integran funciones clave como la gestión de inventarios, el servicio al cliente, la planificación de recursos empresariales (ERP), y la gestión de relaciones con clientes (CRM). Ejemplos de sistemas que soportan procesos de negocio incluyen:
   - **ERP (Enterprise Resource Planning)** como SAP o Microsoft Dynamics, que gestionan recursos y operaciones.
